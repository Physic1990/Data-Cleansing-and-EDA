---
title: "Exploratory Data Analysis of Apple Stock Data"
author: "Shashwot Niraula"
date: "2024-03-03"
output:
...
This report documents the exploratory data analysis of Apple stock data from 2020 to 2021.
...
# Load the data set from the Excel file
...
#Perform exploratory data analysis #Summary statistics (handling NA values)
...
#Add metadata to the data frame \# Description
...
```{r}
ggplot(data = AAPL_2020_2021, aes(x = Date, y = Close)) + geom_line() + labs(title = "Apple Stock Prices Over Time", x = "Date", y = "Close Price")
```
...
ggplot(data = melt(correlation_matrix), aes(x = Var1, y = Var2, fill = value)) +     geom_tile() + 
...
ggplot(data = AAPL_2020_2021, aes(x = Date, y = Returns)) + geom_line() + labs(title = "Volatility of Apple Stock Returns Over Time", x = "Date", y = "Returns")
```
...
```{r}
AAPL_ts <- ts(AAPL_2020_2021$Close, frequency = 7) 
